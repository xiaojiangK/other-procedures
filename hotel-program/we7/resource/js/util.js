...
util.url = function(e, t) {
    ...
    var r = e * Math.PI / 180, i = t * Math.PI / 180, o = r - i, s = n * Math.PI / 180 - a * Math.PI / 180, u = 2 * Math.asin(Math.sqrt(Math.pow(Math.sin(o / 2), 2) + Math.cos(r) * Math.cos(i) * Math.pow(Math.sin(s / 2), 2)));
    ...
    var a = n.getMonth() + 1, r = n.getDate();
